...
class ExpertisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expertise" do
    assert_difference('Expertise.count') do
      post expertises_url, params: { expertise: { description: @expertise.description, title: @expertise.title } }
    end
  ...
  test "should update expertise" do
    patch expertise_url(@expertise), params: { expertise: { description: @expertise.description, title: @expertise.title } }
