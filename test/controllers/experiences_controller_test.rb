...
class ExperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experience" do
    assert_difference('Experience.count') do
      post experiences_url, params: { experience: { duration: @experience.duration, job_title: @experience.job_title } }
    end
  ...
  test "should update experience" do
    patch experience_url(@experience), params: { experience: { duration: @experience.duration, job_title: @experience.job_title } }
