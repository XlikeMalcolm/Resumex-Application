...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { city: @education.city, country: @education.country, duration: @education.duration, institution: @education.institution, qualification: @education.qualification, references: @education.references } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { city: @education.city, country: @education.country, duration: @education.duration, institution: @education.institution, qualification: @education.qualification, references: @education.references } }
