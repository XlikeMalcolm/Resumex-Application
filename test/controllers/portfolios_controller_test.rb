...
class PortfoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post portfolios_url, params: { portfolio: { image: @portfolio.image, references: @portfolio.references, title: @portfolio.title, website: @portfolio.website } }
    end
  ...
  test "should update portfolio" do
    patch portfolio_url(@portfolio), params: { portfolio: { image: @portfolio.image, references: @portfolio.references, title: @portfolio.title, website: @portfolio.website } }
