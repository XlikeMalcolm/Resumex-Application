class InterestsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @interest.save
        format.html { redirect_to new_interest_path, notice: 'Interest was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @interest.update(interest_params)
        format.html { redirect_to new_interest_path, notice: 'Interest was successfully updated.' }
