class EducationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @education.save
        format.html { redirect_to new_education_path, notice: 'Education was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @education.update(education_params)
        format.html { redirect_to new_education_path, notice: 'Education was successfully updated.' }
  ...
  private
    ...
    def education_params
      params.require(:education).permit(:duration, :qualification, :institution, :city, :country)
    end
end
